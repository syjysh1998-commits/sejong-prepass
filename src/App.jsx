...
const DONG_DATA = [
  { id: "haemil", name: "해밀동", x: 39, y: 6, waiting: 3 },
  { id: "goun", name: "고운동", x: 6, y: 16, waiting: 7 },
  { id: "areum", name: "아름동", x: 14, y: 12, waiting: 2 },
  { id: "dodam", name: "도담동", x: 24, y: 26, waiting: 5 },
  { id: "jongchon", name: "종촌동", x: 17, y: 39, waiting: 12, isMain: true },
  { id: "eojin", name: "어진동", x: 29, y: 41, waiting: 4 },
  { id: "naseong", name: "나성동", x: 28, y: 56, waiting: 1 },
  { id: "dajeong", name: "다정동", x: 12, y: 48, waiting: 6 },
  { id: "saerom", name: "새롬동", x: 17, y: 60, waiting: 9 },
  { id: "hansol", name: "한솔동", x: 21, y: 71, waiting: 8 },
  { id: "boram", name: "보람동", x: 49, y: 72, waiting: 3 },
  { id: "daepyeong", name: "대평동", x: 35, y: 84, waiting: 2 },
  { id: "bangok", name: "반곡동", x: 67, y: 52, waiting: 4 },
  { id: "sodam", name: "소담동", x: 61, y: 64, waiting: 1 },
];
